...
namespace WebAppLab
{
    public class ServiceApi
    {
        ...
        #region Agencias
        public async Task<IEnumerable<AgenciaEntity>> AgenciaGet()
        {
            var result = await client.ServicioGetAsync<IEnumerable<AgenciaEntity>>("api/Agencia");
        ...
        public async Task<AgenciaEntity> AgenciaGetById(int id)
        {
            var result = await client.ServicioGetAsync<AgenciaEntity>("Agencia/" + id);
