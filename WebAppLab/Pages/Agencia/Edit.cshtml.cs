...
namespace WebAppLab.Pages.Agencia
{
    public class EditModel : PageModel
    {
        ...
        public EditModel(AgenciaService agenciaService, CatalogoProvinciaService catalogoProvinciaService, CatalogoCantonService catalogoCantonService, CatalogoDistritoService catalogoDistritoService)
        {
